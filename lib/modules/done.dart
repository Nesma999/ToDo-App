  ...
  Widget build(BuildContext context) {
    return BlocConsumer<BottomNavigationCubit, AppStates>(
        ...
        builder: (context, state) {
          var tasks = BottomNavigationCubit.get(context).Donetasks.length;
          return tasks > 0
              ? ListView.separated(
            itemBuilder: (context, index) {
              return buildTaskItem(
                  BottomNavigationCubit.get(context).Donetasks[index],context);
            },
            ...
            itemCount: BottomNavigationCubit.get(context).Donetasks.length,
          )
              : Center(
            child: Column(
